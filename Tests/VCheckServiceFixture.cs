...
//    protected TestData Mocks => Configuration.GetSection("Mocks")?.Get<TestData>() ?? throw new InvalidOperationException("Couldn't get Mocks section");

//    [OneTimeSetUp]
//    public void OneTimeSetUp() {
//      Configuration = new ConfigurationBuilder()
//        .AddJsonFile("appsettings.json")
//        .AddUserSecrets<TestData>()
//        .Build();
